...
```
System.MissingMethodException: Constructor on type 'Mapster.EFCore.MapsterAsyncEnumerable`1[[Wally.RomMaster.Contracts.Responses.Users.GetUserResponse, Wally.RomMaster.Contracts, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]' not found.
   ...
   at Wally.RomMaster.Persistence.Repository`1.GetAsync[TResult](Guid id, CancellationToken cancellationToken) in C:\repo\wally\wally.CleanArchitecture\src\Wally.RomMaster.Persistence\Repository.cs:line 0
   at Wally.RomMaster.Application.Users.Queries.GetUserQueryHandler.HandleAsync(GetUserQuery query, CancellationToken cancellationToken) in C:\repo\wally\wally.CleanArchitecture\src\Wally.RomMaster.Application\Users\Queries\GetUserQueryHandler.cs:line 19
   at Wally.RomMaster.Application.Abstractions.QueryHandler`2.Handle(TQuery query, CancellationToken cancellationToken) in C:\repo\wally\wally.CleanArchitecture\src\Wally.RomMaster.Application\Abstractions\QueryHandler.cs:line 16
