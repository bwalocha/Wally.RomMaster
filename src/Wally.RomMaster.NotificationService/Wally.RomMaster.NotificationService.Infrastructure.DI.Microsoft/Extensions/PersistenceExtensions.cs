...
using Wally.RomMaster.NotificationService.Infrastructure.DI.Microsoft.Providers;
...
using Wally.RomMaster.NotificationService.Infrastructure.Persistence.SQLite;
	...
	private static void WithSqlite(DbContextOptionsBuilder options, AppSettings settings)
	{
		options.UseSqlite(
				...
				builder =>
				{
					...
					The entity type 'User' is configured to use schema 'NotificationService', but SQLite does not support schemas.
