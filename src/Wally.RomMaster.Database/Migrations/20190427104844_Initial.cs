...
namespace Wally.RomMaster.Database.Migrations
{
	public partial class Initial : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateIndex(name: "IX_Dat_FileId", table: "Dat", column: "FileId");
			...
			migrationBuilder.CreateIndex(name: "IX_File_Path", table: "File", column: "Path", unique: true);

			migrationBuilder.CreateIndex(name: "IX_Game_DatId", table: "Game", column: "DatId");
		...
		protected override void Down(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.DropTable(name: "Dat");
