...
namespace Wally.RomMaster.Persistence.Mappings
{
	internal class FileMapping : IEntityTypeConfiguration<File>
	{
		public void Configure(EntityTypeBuilder<File> builder)
		{
			...
			builder.Property(a => a.Crc).IsRequired(false).HasMaxLength(64);
			builder.Property(a => a.Md5).IsRequired(false).HasMaxLength(32);
			builder.Property(a => a.Sha1).IsRequired(false).HasMaxLength(40);
