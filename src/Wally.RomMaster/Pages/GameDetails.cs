	...
	public class GameDetailsModel : Microsoft.AspNetCore.Components.ComponentBase
	{
			...
			GridOptions = new GridOptions<RomViewModel>
						{
							...
							Columns = new GridColumn<RomViewModel>[]
									{
										new GridColumn<RomViewModel>
										{
											Caption = "Id",
											Bind = (a) => new MarkupString($"<a href='/roms/{a.Id}'>{a.Id}</a>")
										},
										new GridColumn<RomViewModel>
										{
										...
										new GridColumn<RomViewModel>
										{
											...
											Bind = (a) => new MarkupString(
												a.Size.ToString(System.Globalization.CultureInfo.InvariantCulture))
										},
										new GridColumn<RomViewModel>
										{
											Caption = "Crc", Bind = (a) => new MarkupString(a.Crc)
										},
										new GridColumn<RomViewModel>
										{
											Caption = "Md5", Bind = (a) => new MarkupString(a.Md5)
										},
										new GridColumn<RomViewModel>
										{
											Caption = "Sh1", Bind = (a) => new MarkupString(a.Sha1)
										}
									}
						};
		}
		...
		protected override async Task OnParametersSetAsync()
		{
			...
			using (var uow = UnitOfWorkFactory.Create())
			{
				...
				var model = await repoDat.FindAsync(a => a.Id == Id, c => c.Include(m => m.Roms)).ConfigureAwait(false);
