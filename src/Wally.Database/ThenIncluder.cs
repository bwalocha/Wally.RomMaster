...
{
	public class ThenIncluder<TEntity, TPreviousProperty> : Includer<TEntity>, IThenIncluder<TEntity, TPreviousProperty>
		where TEntity : class
	{
		...
		public ThenIncluder<TEntity, TProperty> ThenInclude<TProperty>(
			Expression<Func<TPreviousProperty, TProperty>> navigationPropertyPath)
		{
			IIncludableQueryable<TEntity, IEnumerable<TPreviousProperty>> source = _querable;
			IIncludableQueryable<TEntity, TProperty> q =
