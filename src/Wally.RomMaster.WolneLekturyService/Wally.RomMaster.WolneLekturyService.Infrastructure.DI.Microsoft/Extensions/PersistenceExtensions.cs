...
using Wally.RomMaster.WolneLekturyService.Infrastructure.DI.Microsoft.Providers;
...
using Wally.RomMaster.WolneLekturyService.Infrastructure.Persistence.SQLite;
	...
	private static void WithSqlite(DbContextOptionsBuilder options, AppSettings settings)
	{
		options.UseSqlite(
				...
				builder =>
				{
					...
					The entity type 'User' is configured to use schema 'WolneLekturyService', but SQLite does not support schemas.
